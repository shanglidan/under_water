...
def main():
    xml_path = 'data/acoustic/train/side/box'
    img_path = 'data/acoustic/train/side/image'
    print('processing {} ...'.format("xml format annotations"))
    cvt_annotations(img_path, xml_path, 'data/acoustic/train/side/annotations/train.json')
    print('Done!')
