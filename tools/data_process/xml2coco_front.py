...
def main():
    xml_path = 'data/acoustic/train/front/box'
    img_path = 'data/acoustic/train/front/image'
    print('processing {} ...'.format("xml format annotations"))
    cvt_annotations(img_path, xml_path, 'data/acoustic/train/front/annotations/train.json')
    print('Done!')
