...
CUDA_VISIBLE_DEVICES=0 python tools/test.py configs/side/20200404_cascade_rcnn_dconv_c3-c5_se101_fpn_1x_lr005_600_800_Vflip_vflip.py work_dirs_side/20200328_cas_dconv_se101_fpn_1x_lr005_600_800_Vflip/epoch_12.pth --json_out data/results/side_se101.json
